...
# simple script to quickly portscan a host.. written to help a 
# brother with OSCP..Scans all ports FUCK loads quicker than just
# using nmap. This is just a simple one, use your own bash foo to
# make it do more..
#----------------------------------------------------------------
#Usage: host-enum.sh 192.168.1.1
#----------------------------------------------------------------
#Tested with nmap 6.02 on BT5R2
#   cd /usr/local/share
#   rm -r nmap
#   svn co --username guest --password "" https://svn.nmap.org/nmap
#   ./configure
#   make
#   make install
#
